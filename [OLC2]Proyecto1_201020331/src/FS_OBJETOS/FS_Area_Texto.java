...
public class FS_Area_Texto extends JTextArea
{
    ...
    public FS_Area_Texto(int p_alto, int p_ancho, String p_fuente, int p_tamaño, Color p_color, int p_pos_x, int p_pos_y, boolean p_bold, boolean p_italic, String p_texto, String p_identificador)
    {
        this.alto = p_alto;
        this.ancho = p_ancho;
