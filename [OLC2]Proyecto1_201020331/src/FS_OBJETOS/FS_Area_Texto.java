 ...
 */
public class FS_Area_Texto extends JTextArea
{
    private String id;
    private int alto;
    private int ancho;
    ...
    //CONTROLADOR PARA FS
    public FS_Area_Texto(int p_alto, int p_ancho, String p_fuente, int p_tamaño, Color p_color, int p_pos_x, int p_pos_y, boolean p_bold, boolean p_italic, String p_texto, String p_id)
    {
        this.id = p_id;        
        this.pos_x = p_pos_x;
        this.pos_y = p_pos_y;
    ...
    //CONTROLADOR PARA GXML
    public FS_Area_Texto(String p_id, int p_pos_x, int p_pos_y)
    {
        this.id = p_id;           
        this.pos_x = p_pos_x;
        this.pos_y = p_pos_y;
    ...
    public void actualizarAreaTexto()
    {
        if(bold && italic)
        {
            nueva_fuente = new Font(fuente, Font.BOLD | Font.ITALIC, tamaño);
    ...
    public String traducirAreaTexto(String padre)
    {        
        return  padre + ".CrearAreaTexto(" + alto + "," + ancho + ",\"" + fuente + "\", " + tamaño + ", \"" +  traducirColor() + "\", " + pos_x + ", " + pos_y + ", " + (bold == true ? "verdadero" : "falso") + ", " + (italic == true ? "verdadero" : "falso") + ", \"" +  texto.trim()  + "\", \"" + id + "\"); \n";
    }
