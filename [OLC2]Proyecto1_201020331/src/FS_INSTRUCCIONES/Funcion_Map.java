 ...
 */
public class Funcion_Map implements Instruccion
{
    private int fila;
    private int columna;
    ...
    public Funcion_Map(Nodo_AST_FS nodo_funcion, FS_Arreglo p_arreglo)
    {
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            if(arreglo.size() > 0)
            {
                if(Tabla_Simbolos.getInstance().existe_metodo(identificador))
                {
                        ...
                        for(int i = 0; i < arreglo.size(); i++)
                        {
                            ...
                            else if(simbolo_aux.getTipo()== Tabla_Enums.tipo_primitivo_Simbolo.retornar)
                            {
                                ...
                                if(simbolo_aux.getTipo() != Tabla_Enums.tipo_primitivo_Simbolo.error || simbolo_aux.getTipo() != Tabla_Enums.tipo_primitivo_Simbolo.identificador || simbolo_aux.getTipo() != Tabla_Enums.tipo_primitivo_Simbolo.detener || simbolo_aux.getTipo() != Tabla_Enums.tipo_primitivo_Simbolo.retornar)
                                {
                                    ...
                                    {
                                        arreglo_final.setHomogeneo(false);
                                    }
                                    ultimo_simbolo = simbolo_aux.getTipo();

                                    arreglo_final.add(simbolo_aux);
                                    arreglo_final.setTipo(simbolo_aux.getTipo());
                                }
                            ...
                            else
                            {
                                ...
                                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                                nuevo_simbolo.setIdentificador( fila + " - " + columna);                                
                                nuevo_simbolo.setValor("La llamada a Funcion Map de Arreglo no puede recibir como retorno objetos o arreglos, así como metodos sin retorno.");

                                return nuevo_simbolo;  
                            }                            
                        }    
                        
                        if(!arreglo_final.getHomogeneo())
                        {
                    ...
                    else
                    {
                        ...
                        nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                        nuevo_simbolo.setIdentificador( fila + " - " + columna);                        
                        nuevo_simbolo.setValor("La llamada a Funcion Map de Arreglo no puede ejecutarse la funcion a ejecutar tiene mas de un parametro o no tiene.");
                ...
                else
                {
                    ...
                    nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    nuevo_simbolo.setIdentificador( fila + " - " + columna);                    
                    nuevo_simbolo.setValor("La llamada a Funcion Map de Arreglo no puede ejecutarse la funcion a ejecutar no existe.");
            ...
            else
            {
                ...
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);                
                nuevo_simbolo.setIdentificador( fila + " - " + columna);                
                nuevo_simbolo.setValor("La llamada a Funcion Map de Arreglo no puede ejecutarse en un arreglo vacio.");
