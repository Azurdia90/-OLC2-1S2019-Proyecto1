 ...
 */
public class Funcion_Todos implements Instruccion
{
    private int fila;
    private int columna;
    ...
    public Funcion_Todos(Nodo_AST_FS nodo_funcion, FS_Arreglo p_arreglo)
    {
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            if(arreglo.size() > 0)
            {
                if(Tabla_Simbolos.getInstance().existe_metodo(identificador))
                {
                    ...
                    if(funcion_llamar.getLista_parametros().size() == 1)
                    {
                        for(int i = 0; i < arreglo.size(); i++)
                        {
                            ...
                            else if(simbolo_aux.getTipo()== Tabla_Enums.tipo_primitivo_Simbolo.retornar)
                            {
                                ...
                                if(simbolo_aux.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.booleano && simbolo_aux.getValor().equals("falso"))
                                {
                            ...
                            else
                            {
                                ...
                                nuevo_simbolo.setValor("La llamada a Funcion Todos de Arreglo no puede recibir como retorno objetos o arreglos, así como metodos sin retorno.");
                        ...
                        nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.booleano);
                        nuevo_simbolo.setIdentificador("10-4");                        
                        nuevo_simbolo.setValor("verdadero");
                    ...
                    else
                    {
                        ...
                        nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                        nuevo_simbolo.setIdentificador( fila + " - " + columna);                        
                        nuevo_simbolo.setValor("La llamada a Funcion Todos de Arreglo no puede ejecutarse la funcion a ejecutar tiene mas de un parametro o no tiene.");
                ...
                else
                {
                    ...
                    nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    nuevo_simbolo.setIdentificador( fila + " - " + columna);                    
                    nuevo_simbolo.setValor("La llamada a Funcion Todos de Arreglo no puede ejecutarse la funcion a ejecutar no existe.");
            ...
            else
            {
                ...
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                nuevo_simbolo.setIdentificador( fila + " - " + columna);                
                nuevo_simbolo.setValor("La llamada a Funcion Todos de Arreglo no puede ejecutarse en un arreglo vacio.");
