 ...
 */
public class Funcion_Obtener_Por_Nombre implements Instruccion
{
    private int fila;
    private int columna;
    ...
    public Funcion_Obtener_Por_Nombre(Nodo_AST_FS nodo_funcion, FS_Arreglo p_arreglo)
    {
        this.fila = Integer.parseInt(nodo_funcion.getFila());
        this.columna = Integer.parseInt(nodo_funcion.getColumna());
        
        this.nombre = nodo_funcion.getValor().substring(1,nodo_funcion.getValor().length()-1);;
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        ...
        {        
            ...
            {                               
                ...
                {
                    if( (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_Texto) || (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_Area_Texto) || (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_Caja_Texto) ||  (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_Spinner) ||  (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_ComboBox) || (arreglo.get(i).getIdentificador().equalsIgnoreCase(nombre) && arreglo.get(i).getValor() instanceof FS_Boton) )
                    {
            ...
            else
            {
                ...
                nuevo_simbolo.setValor("La llamada a Funcion Obtener Por Nombre de Arreglo no puede ejecutarse en un arreglo vacio.");
