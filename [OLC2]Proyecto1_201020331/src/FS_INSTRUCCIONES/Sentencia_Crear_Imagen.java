 ...
 */
public class Sentencia_Crear_Imagen implements Instruccion        
{
    private int fila;
    private int columna;
    ...
    public Sentencia_Crear_Imagen(Nodo_AST_FS nodo_sentencia)
    {
        ...
        this.alto = new Expresion(nodo_sentencia.getHijos().get(3));
        this.ancho = new Expresion(nodo_sentencia.getHijos().get(4));        
    }
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            if(path_r.getTipo() != Tabla_Enums.tipo_primitivo_Simbolo.cadena)
            {
                ...
                nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, el path debe ser una cadena.");
            ...
            if(!(posx_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.entero || posx_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.decimal))
            {
                ...
                nuevo_simbolo.setIdentificador( fila + " - " + columna);
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, la posicion en x debe ser un valor numerico.");
            ...
            if(!(posy_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.entero || posy_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.decimal))
            {
                ...
                nuevo_simbolo.setIdentificador( fila + " - " + columna);
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, la posicion en y debe ser un valor numerico.");
            ...
            if(!(alto_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.entero || alto_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.decimal))
            {
                ...
                nuevo_simbolo.setIdentificador( fila + " - " + columna);
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, el alto debe ser un valor numerico.");
            ...
            if(!(ancho_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.entero || ancho_r.getTipo() == Tabla_Enums.tipo_primitivo_Simbolo.decimal))
            {
                ...
                nuevo_simbolo.setIdentificador( fila + " - " + columna);
                nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, el ancho debe ser un valor numerico.");

                return nuevo_simbolo;
            }
            
            FS_Imagen nueva_imagen = new FS_Imagen(path_r.getValor().toString(), Integer.parseInt(posx_r.getValor().toString()), Integer.parseInt(posy_r.getValor().toString()), Integer.parseInt(alto_r.getValor().toString()), Integer.parseInt(ancho_r.getValor().toString()),salida);
            ...
            else
            {
                ...
                else
                {
                    if(contenedor.getValor() instanceof FS_Ventana)
                    {
                        ...
                        ventana_modificar.getLista_componentes().add(nueva_imagen);
                        ventana_modificar.add(nueva_imagen);
                    ...
                    else if(contenedor.getValor() instanceof FS_Contenedor)
                    {
                        ...
                        contenedor_modificar.getLista_componentes().add(nueva_imagen);
                        contenedor_modificar.add(nueva_imagen);
                    ...
                    nuevo_simbolo.setValor("La imagen fue agregado correctamente");  
        ...
        catch(Exception e)
        {
            ...
            nuevo_simbolo.setIdentificador( fila + " - " + columna);
            nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
            nuevo_simbolo.setValor("La Creación de la Imagen no fue realizada, error: " + e.getMessage());
