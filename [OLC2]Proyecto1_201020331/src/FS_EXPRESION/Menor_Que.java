 ...
 */
public class Menor_Que implements Instruccion
{
    ...
    */
    ...
    private Tabla_Enums.tipo_operacion [][] tabla_menor_que = {                                                 
                                                                ...
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.menorque_booleano,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.menorque_numerico,Tabla_Enums.tipo_operacion.menorque_numerico,Tabla_Enums.tipo_operacion.menorque_numerico_caracter,Tabla_Enums.tipo_operacion.menorque_numerico_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.menorque_numerico,Tabla_Enums.tipo_operacion.menorque_numerico,Tabla_Enums.tipo_operacion.menorque_numerico_caracter,Tabla_Enums.tipo_operacion.menorque_numerico_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.menorque_caracter_numerico,Tabla_Enums.tipo_operacion.menorque_caracter_numerico,Tabla_Enums.tipo_operacion.menorque_caracter,Tabla_Enums.tipo_operacion.menorque_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.menorque_caracter_numerico,Tabla_Enums.tipo_operacion.menorque_caracter_numerico,Tabla_Enums.tipo_operacion.menorque_caracter,Tabla_Enums.tipo_operacion.menorque_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error}
                                                              };
    public Menor_Que(Expresion p_izq, Expresion p_der) 
    {
        this.p_izq = p_izq;
        this.p_der = p_der;
    }
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            resultado = tabla_menor_que[valor1.getTipo().ordinal()] [valor2.getTipo().ordinal()];
            boolean resultado_final = false;
            Simbolo nuevo_simbolo = new Simbolo();
            
            switch(resultado)
            {
                case menorque_numerico:
                ...
                case menorque_booleano:                    
                    ...
                    return nuevo_simbolo;
                case menorque_numerico_caracter:
                    ...
                    return nuevo_simbolo;
                case menorque_caracter_numerico:
                ...
                default:                    
                    ...
                    nuevo_simbolo.setIdentificador("33-12");
                    nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    nuevo_simbolo.setValor("No es posible realizar menor que, verifique los valores.");
        ...
        catch(Exception e)
        {
            ...
            nuevo_simbolo.setIdentificador("33-12");
            nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
            nuevo_simbolo.setValor("No es posible realizar menor que, error: " + e.getMessage());
