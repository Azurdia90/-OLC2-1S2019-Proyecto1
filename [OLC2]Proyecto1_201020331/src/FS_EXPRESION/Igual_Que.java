 ...
 */
public class Igual_Que implements Instruccion
{
    ...
    */
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            resultado = tabla_igual_que[valor1.getTipo().ordinal()] [valor2.getTipo().ordinal()];
            ...
            switch(resultado)
            {
                ...
                default:                    
                    ...
                    nuevo_simbolo.setIdentificador("33-12");
                    nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    nuevo_simbolo.setValor("No es posible realizar igual que, verifique los valores.");
        ...
        catch(Exception e)
        {
            ...
            nuevo_simbolo.setIdentificador("33-12");
            nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
            nuevo_simbolo.setValor("No es posible realizar igual que, error: " + e.getMessage());
