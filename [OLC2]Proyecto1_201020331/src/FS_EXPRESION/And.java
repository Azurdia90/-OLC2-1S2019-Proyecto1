 ...
 */
public class And implements Instruccion
{
    ...
    public And(Expresion p_izq, Expresion p_der) 
    {
        this.p_izq = p_izq;
        this.p_der = p_der;
    }
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            else
            {
                ...
                nuevo_simbolo.setValor("No es posible realizar And con valores no booleanos.");    
            }
        ...
        catch(Exception e)
        {
            ...
            nuevo_simbolo.setIdentificador("33-12");
            nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
            nuevo_simbolo.setValor("No es posible realizar And, error: " + e.getMessage());
