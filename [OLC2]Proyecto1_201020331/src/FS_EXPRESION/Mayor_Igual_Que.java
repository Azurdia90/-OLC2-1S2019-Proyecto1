 ...
 */
public class Mayor_Igual_Que implements Instruccion
{
    ...
    */
    ...
    private Tabla_Enums.tipo_operacion [][] tabla_mayor_igual_que = {                                                 
                                                                        ...
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.mayorigualque_booleano,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.mayorigualque_numerico,Tabla_Enums.tipo_operacion.mayorigualque_numerico,Tabla_Enums.tipo_operacion.mayorigualque_numerico_caracter,Tabla_Enums.tipo_operacion.mayorigualque_numerico_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.mayorigualque_numerico,Tabla_Enums.tipo_operacion.mayorigualque_numerico,Tabla_Enums.tipo_operacion.mayorigualque_numerico_caracter,Tabla_Enums.tipo_operacion.mayorigualque_numerico_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.mayorigualque_caracter_numerico,Tabla_Enums.tipo_operacion.mayorigualque_caracter_numerico,Tabla_Enums.tipo_operacion.mayorigualque_caracter,Tabla_Enums.tipo_operacion.mayorigualque_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.mayorigualque_caracter_numerico,Tabla_Enums.tipo_operacion.mayorigualque_caracter_numerico,Tabla_Enums.tipo_operacion.mayorigualque_caracter,Tabla_Enums.tipo_operacion.mayorigualque_caracter,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error},
                                                                        {Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error,Tabla_Enums.tipo_operacion.error}
                                                                    };
    public Mayor_Igual_Que(Expresion p_izq, Expresion p_der) 
    {
        this.p_izq = p_izq;
        this.p_der = p_der;
    }
    ...
    public Simbolo ejecutar(Entorno entorno_local, ObjetoEntrada salida) 
    {
        try
        {
            ...
            resultado = tabla_mayor_igual_que[valor1.getTipo().ordinal()] [valor2.getTipo().ordinal()];
            boolean resultado_final = false;
            Simbolo nuevo_simbolo = new Simbolo();
            
            switch(resultado)
            {
                case mayorigualque_numerico:
                ...
                case mayorigualque_booleano:                    
                    ...
                    return nuevo_simbolo;
                case mayorigualque_numerico_caracter:
                    ...
                    return nuevo_simbolo;
                case mayorigualque_caracter_numerico:
                ...
                default:                    
                    ...
                    nuevo_simbolo.setIdentificador("33-12");
                    nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    nuevo_simbolo.setValor("No es posible realizar mayor igual que, verifique los valores.");
        ...
        catch(Exception e)
        {
            ...
            nuevo_simbolo.setIdentificador("33-12");
            nuevo_simbolo.setTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
            nuevo_simbolo.setValor("No es posible realizar mayor igual que, error: " + e.getMessage());
